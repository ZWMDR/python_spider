...
def saveData(comments):
    ...
    filename = './interstellar_comments.csv'
...
def main():   
    ...
    # 电影上映时间
    end_time = '2014-11-12  00:00:00'
    
    while start_time > end_time:
        url = 'http://m.maoyan.com/mmdb/comments/movie/248172.json?_v_=yes&offset=20&startTime=' + start_time.replace('  ', '%20')
        html = None
        print(url)
        try:
            html = requestApi(url)
