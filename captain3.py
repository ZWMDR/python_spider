...
def saveData(comments):
    ...
    filename = './captain3_comments.csv'
...
def main():   
    ...
    # 电影上映时间
    end_time = '2016-05-06  00:00:00'
    
    while start_time > end_time:
        url = 'http://m.maoyan.com/mmdb/comments/movie/246234.json?_v_=yes&offset=20&startTime=' + start_time.replace('  ', '%20')
        html = None
        print(url)
        try:
            html = requestApi(url)
